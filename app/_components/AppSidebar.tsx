...
import {Calendar, Home, Inbox, Layers, Search, Settings, UserCircleIcon, Wallet} from "lucide-react"
            ...
            <SidebarHeader>
                <div className='p-4'>
                    <Image src={'./logo.png'} alt='logo' width={100} height={70}
                        className='w-full' />
                    <h2 className='text-sm text-gray-400 text-center mt-3'>Build Awesome</h2>
                </div>
            </SidebarHeader>
            <SidebarContent>
                <SidebarGroup>
