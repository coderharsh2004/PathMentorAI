...
function WelcomeBanner(){
    return(
        <div className='p-5 bg-gradient-to-tr from-[#BE575F] via -[#A338E3] to-[#AC76D6] rounded-xl'>
            ...
            <p className='text-white'>Smarter career decisions start here - get tailored advice, real-time market insights and a roadmap built for you with the power of AI</p>
            <Button variant={'outline'} className='mt-3' >Let's Get Started</Button>
        </div>
    )
}
export default WelcomeBanner;
>>>>>>> 7393ddc020785b99f32d3b6c562c427c8bdcd18d
